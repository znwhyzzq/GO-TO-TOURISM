...
import com.zzq.mapper.RoutelMapper;
import com.zzq.qo.RouteQuery;
import com.zzq.service.AdminService;
import com.zzq.service.RoutelService;
...
public class RoutelServiceImpl extends ServiceImpl<RoutelMapper, Routel> implements RoutelService {
    ...
    public Page<Routel> listPage(RouteQuery query) {
        ...
        lambdaQueryWrapper.like(StringUtils.isNotBlank(query.getStartSite()), Routel::getStartSite, query.getStartSite());
        lambdaQueryWrapper.like(StringUtils.isNotBlank(query.getEndSite()), Routel::getEndSite, query.getEndSite());
