...
import com.zzq.mapper.InsuranceMapper;
import com.zzq.qo.InsuranceQuery;
import com.zzq.service.InsuranceService;
...
public class InsuranceServiceImpl extends ServiceImpl<InsuranceMapper, Insurance> implements InsuranceService {
    ...
    public Boolean saveOrUpdateInsurance(Insurance insurance) {
        ...
        if (id == null) {
            ...
            LambdaQueryWrapper<Insurance> queryWrapper = new LambdaQueryWrapper<>();
            queryWrapper.eq(Insurance::getId, insurance.getId());
            boolean update1 = update(insurance, queryWrapper);
            //2.删除缓存
