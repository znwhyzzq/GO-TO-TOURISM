...
import com.zzq.mapper.CarMapper;
import com.zzq.qo.CarQuery;
import com.zzq.service.CarService;
...
import static com.zzq.constant.RedisConstants.CACHE_CAR_COUNT0_KEY;
import static com.zzq.constant.RedisConstants.CACHE_CAR_KEY;
...
public class CarServiceImpl extends ServiceImpl<CarMapper, Car> implements CarService {
    ...
    public Integer count1() {
        String key = CACHE_CAR_COUNT0_KEY;
    ...
    public ResponseResult saveOrUpdateCar(Car car) {
        ...
        if (id == null) {
            ...
            redisTemplate.delete(CACHE_CAR_KEY + id);
    ...
    public void deleteById(Long id) throws Exception {
        ...
        redisTemplate.delete(CACHE_CAR_COUNT0_KEY);
    }
