...
import com.zzq.DTO.OrderExcelDto;
...
import com.zzq.vo.OrderExcelVo;
import com.zzq.vo.OrderIdsVo;
...
public class OrderController {
    ...
    public ResponseResult attractions() {
        return ResponseResult.success(orderService.attractions());
    }
    ...
    public ResponseResult orderListPage(@RequestBody UserOrderQuery query) throws GlobalExceptionHandler {
        System.out.println(orderService.orderListPage(query));
    ...
    //订单已支付总金额
    @GetMapping("/getOrderPayedTotal")
    public ResponseResult getOrderPayedTotal(){
        return ResponseResult.success(orderService.getOrderPayedTotal());
    }
