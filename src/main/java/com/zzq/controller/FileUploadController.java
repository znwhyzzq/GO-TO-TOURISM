...
public class FileUploadController {
    ...
    public ResponseResult uploadFile(@RequestParam(value = "file", required = false) MultipartFile file) {
        ...
        // 设置保存地址（这里是转义字符）
        //1.后台保存位置
        String path = "D:\\Java\\tourism-website-background-vue2-master\\tourism-website-background-vue2-master\\src\\assets\\images\\";
    ...
    public ResponseResult uploadFileUser(@RequestParam(value = "file", required = false) MultipartFile file) {
        ...
        String fileName = System.currentTimeMillis() + "." + OriginalFilename.substring(OriginalFilename.lastIndexOf(".") + 1);
        // 设置保存地址（这里是转义字符）
        String path2 = "D:\\Java\\tourism-website-vue2-master\\tourism-website-vue2-master\\src\\assets\\images\\";
